...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'Login_Screen1.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/Login_Screen1.html'`` the file from the app1 package is loaded,
    by loading ``'app2/Login_Screen1.html'`` the file from the second.
    """
